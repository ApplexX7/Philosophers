...
/*   Updated: 2024/02/05 11:16:47 by mohilali         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	*monitoring(void *thread)
{
	...
	while (1)
	{
		if (check_philos_dead(threads->philo[i]) == 1)
		{
